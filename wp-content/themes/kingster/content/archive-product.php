 ...
 */
	...
	$settings = array(
		'query' => $wp_query,
		'thumbnail-size' => kingster_get_option('general', 'woocommerce-archive-thumbnail', 'full'),
		'column-size' => kingster_get_option('general', 'woocommerce-archive-column-size', '20'),
