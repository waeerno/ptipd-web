<?php
	...
	add_filter('revslider_getUsedFonts', 'kingster_revslider_getUsedFonts');
	if( !function_exists('kingster_revslider_getUsedFonts') ){
		function kingster_revslider_getUsedFonts( $used_font ){
