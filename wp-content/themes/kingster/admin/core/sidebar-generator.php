		...
		class gdlr_core_sidebar_generator{
			...
			function __construct( $sidebar_args = array() ){
				...
				$this->footer_widgets = array(
					array( 'name'=>esc_html__('Footer 1', 'kingster'), 'id'=>'footer-1', 'description'=>esc_html__('Footer Column 1', 'kingster') ), 
					array( 'name'=>esc_html__('Footer 2', 'kingster'), 'id'=>'footer-2', 'description'=>esc_html__('Footer Column 2', 'kingster') ), 
					array( 'name'=>esc_html__('Footer 3', 'kingster'), 'id'=>'footer-3', 'description'=>esc_html__('Footer Column 3', 'kingster') ), 
					array( 'name'=>esc_html__('Footer 4', 'kingster'), 'id'=>'footer-4', 'description'=>esc_html__('Footer Column 4', 'kingster') )
				);
